...
def post_to_wordpress(title: str = None, content: str = None, slug: str = None, excerpt: str = None) -> str:
    """
    ...
    if not title or title.strip() == "":
        print("⚠️ Warning: Missing title. Using fallback title.")
        title = "Auto Generated Salesforce Article"

    if not slug or slug.strip() == "":
        print("⚠️ Warning: Missing slug. Generating fallback slug.")
        slug = title.lower().replace(" ", "-").replace("|", "-")[:60]

    if not excerpt or excerpt.strip() == "":
        print("⚠️ Warning: Missing excerpt. Using fallback excerpt.")
        excerpt = "A Salesforce article generated by AI automation."

    if not content or content.strip() == "":
        print("⚠️ Warning: Missing content. Using fallback content.")
        content = "<p>No content generated. Placeholder blog post.</p>"
